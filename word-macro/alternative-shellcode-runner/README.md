...
| `vba-alternative-shellcode-runner.vba` | VBA macro — XOR decrypt, HeapAlloc, EnumSystemGeoID execution |
...
**4. Paste the output into `vba-alternative-shellcode-runner.vba`:**
```vb
Warhead = Array(246, 50, 8, ...)   ' ← replace
...
2. Paste the full contents of `vba-alternative-shellcode-runner.vba`
